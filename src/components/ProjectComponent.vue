<template>
  ...
  <div class="github">
    ...
    <a :href="githubProject">View Code</a>
    <span class="stack">Tech stack: {{ stack }}</span>
  </div>
  </div>
